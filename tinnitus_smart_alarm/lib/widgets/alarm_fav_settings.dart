...
class AlarmFavSettings extends StatefulWidget {
  const AlarmFavSettings({super.key});

  @override
  State<AlarmFavSettings> createState() => _AlarmFavSettingsState();
}

class _AlarmFavSettingsState extends State<AlarmFavSettings> {
  late bool loopAudio;
  late bool vibrate;
  late double? volume;
